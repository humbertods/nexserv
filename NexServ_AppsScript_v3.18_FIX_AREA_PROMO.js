  ...
  for (let i = 3; i < allData.length; i++) {
    ...
    if (estado === 'en servicio' && tomadaPor === data.chicaNombre && nombre === data.clienteNombre) {
      ...
      if (data.esRetiro) {
        ...
        // Determinar el area de la siguiente promo para que la vean los staff correctos
        ...
        ws.getRange(row, 7).setValue(sigArea);               // G: Area actualizada a la de la siguiente promo
