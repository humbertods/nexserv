...
function handleGetAutorizaciones() {
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    // Devolver pendientes Y aprobados — el frontend necesita los aprobados para recargarlos al volver
    // Los rechazados y otros estados se omiten
    if (estado !== 'pendiente' && estado !== 'aprobado') continue;
